<div class="chapter-nav" id="chapter-nav-top">
    ...
    <div class="btn-group">
        ...
        @if($chapterNav['nextChapter'])
            <a class="btn btn-success" href="{{ route('chapter.show', [$story->alias, $chapterNav['nextChapter']->alias])  }}" title="{{$chapterNav['nextChapter']->subname}}" id="next_chap"><span class="hidden-xs">Chương </span>sau <span class="glyphicon glyphicon-chevron-right"></span></a>
        @else
