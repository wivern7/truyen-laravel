...
<div class="navbar navbar-default navbar-static-top" role="navigation" id="nav">
    <div class="container">
        <div class="navbar-header">
            ...
            <h1><a class="header-logo" href="/" title="Đọc truyện online - TopTit">Đọc truyện online - TruyenChonLoc</a></h1>
        </div>
            ...
            <!--
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <?php if(Auth::user()): ?>
                                <a href="<?php echo e(route("dashboard.index")); ?>"><span class="glyphicon glyphicon-cog"></span>  Trang Quản Trị</a>
                            <?php else: ?>
