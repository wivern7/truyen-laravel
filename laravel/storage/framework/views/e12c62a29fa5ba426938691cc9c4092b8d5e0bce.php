<div class="container" id="truyen-slide">
    <div class="list list-thumbnail col-xs-12">
        <div class="title-list"><h2><a href="<?php echo e(route('danhsach.truyenfull')); ?>" title="Truyện full">Truyện đã hoàn thành</a></h2><a href="http://www.toptit.com/danh-sach/truyen-full/" title="Truyện full"><span class="glyphicon glyphicon-menu-right"></span></a></div>
        <div class="row">
            <?php if($stories): ?>
