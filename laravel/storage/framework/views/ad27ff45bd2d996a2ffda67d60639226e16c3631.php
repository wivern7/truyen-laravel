      ...
      <div class="wrapper">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <a href="<?php echo e(url('/dashboard/')); ?>">
                  <i class="fa fa-cogs"></i> <span>Trang Quản Trị</span>
                </a>
              </li>
              <?php if( Auth::user()->isAdmin()): ?>
              <li class="treeview">
        ...
        <footer class="main-footer">
          <div class="pull-right hidden-xs">
            <b>Phiên bản:</b> Thử nghiệm
          </div>
          <strong>Copyright &copy; 2015-<?php echo date('Y'); ?> <a href="http://www.hohoangson.net">Hồ Hoàng Sơn</a>.</strong> All rights
          reserved.
        </footer>
