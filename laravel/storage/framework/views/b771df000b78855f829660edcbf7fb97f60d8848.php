<div class="chapter-nav" id="chapter-nav-top">
    ...
    <div class="btn-group">
        ...
        <?php if($chapterNav['nextChapter']): ?>
            <a class="btn btn-success" href="<?php echo e(route('chapter.show', [$story->alias, $chapterNav['nextChapter']->alias])); ?>" title="<?php echo e($chapterNav['nextChapter']->subname); ?>" id="next_chap"><span class="hidden-xs">Chương </span>sau <span class="glyphicon glyphicon-chevron-right"></span></a>
        <?php else: ?>
